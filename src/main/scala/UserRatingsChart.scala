/**
  ...
  * https://github.com/ippromek/spark-ml/blob/branch-ed2/Chapter_04/scala/2.0.0/src/main/scala/org/sparksamples/UserRatingsChart.scala
  */
...
object UserRatingsChart {
  ...
  def main(args: Array[String]) {
    ...
    val rating_df = spark.read.format("com.databricks.spark.csv")
      ...
      .load("C:\\Users\\oleg.baydakov\\IdeaProjects\\SparkMachineLearning2edition\\src\\main\\resources\\u.data")
